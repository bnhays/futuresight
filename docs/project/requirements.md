...
- The system should let users log basic matchup results for a specific deck version.
...
- Matchup logging is limited to opponent deck, tournament, outcome, and created date on a selected deck version.
- Deck statistics are limited to current client-side analysis panels; the backend statistics module remains a placeholder.
